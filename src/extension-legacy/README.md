# Job Filter - Legacy Chrome Extension (Archived)

> This folder is archived. The active extension lives in `src/extension-v2-scoring`.
> This legacy version is retained for reference only.
...
4. Select the `/src/extension-legacy/` folder from this repository
